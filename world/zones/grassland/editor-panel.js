// Grassland zone — Area Designer DOM overlay: add/export toolbar (built
// once per zone build) + a property panel that refreshes on every
// selection/transform change. Talks to editor.js only through its exported
// functions/callback — never reaches into its internals.
...
export function disposeEditorPanel() {
