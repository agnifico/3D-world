// Grassland zone — terrain math and layout data. Pure functions of (x, z);
// no THREE import, no rendering concerns, so this module is plain-JS testable.
// The height-CONTRIBUTOR REGISTRY that used to live here moved to
// core/height-registry.js (shared shell service, reset per zone-swap) —
// this file's build(ctx) registers terrainHeight into it instead of owning
// the registry itself.
import { clamp01 } from '../../core/math.js';
export { clamp01 }; // re-exported — terrain-mesh.js/minimap.js/editor.js import it from here
